...
export default function Home() {
  const icons = [
    ...
    //   img: "/logos/experience/greenwork.png",
    //   hoverImg: "/logos/experience/work.png",
    //   label: "Seeking work for Fall 2026!",
    //   imgClassName: "brightness-120",
    // },
    {
      href: "https://avante.io/",
      img: "/logos/experience/gAvante.png",
      hoverImg: "/logos/experience/avante.png",
      label: "Forward Deployed Engineer",
      imgClassName: "saturate-100 brightness-120",
    },
    {
      href: "https://linkedin.com/in/michaelpasyechnyk",
      img: "/logos/map.png",
  ...
  return (
    <motion.div
      ...
      className="w-full h-full flex items-center justify-center md:mt-14 px-8"
    >
