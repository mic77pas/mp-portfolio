  ...
  return (
    <main className="flex flex-col gap-8 text-[#c7d3b4]">
      ...
      <AnimatedProjectSection delay={0.3}>
        <div className="flex justify-between -mt-6 w-full text-shadow-[0px_3px_1px_rgba(0,0,0,0.5)]">
          {prevProject ? (
            <Link
              href={`/portfolio/${prevProject.slug}`}
              className="font-minecraft text-[#90AD8F] hover:text-[#b7d4b3]"
            >
              &agt; {prevProject.title}
            </Link>
          ) : (
            <div />
          )}
      ...
      <div className="font-minecraft">
        <AnimatedProjectSection delay={0.1}>
          <p className="text-2xl">What tools</p>
        </AnimatedProjectSection>
        <AnimatedProjectSection delay={0.2}>
          <p className="text-2xl">What is it</p>
        </AnimatedProjectSection>
        <AnimatedProjectSection delay={0.3}>
          <p className="text-2xl">Why this project</p>
        </AnimatedProjectSection>
        <AnimatedProjectSection delay={0.4}>
          <p className="text-2xl">What did I learn?</p>
        </AnimatedProjectSection>
        <AnimatedProjectSection delay={0.5}>
          <Link
            href="/portfolio"
            className="ml-auto font-bold flex w-fit items-center gap-2 font-minecraft text-[#90AD8F] hover:text-[#b7d4b3]"
          >
            All projects &gt;
          </Link>
        </AnimatedProjectSection>
